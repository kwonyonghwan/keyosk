...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="MenuId" v-model="value.menuId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            MenuId :  {{value.menuId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="MenuCount" v-model="value.menuCount"/>
          </div>
          <div class="grey--text ml-4" v-else>
            MenuCount :  {{value.menuCount }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="TotalPrice" v-model="value.totalPrice"/>
          </div>
          <div class="grey--text ml-4" v-else>
            TotalPrice :  {{value.totalPrice }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="RejectCode" v-model="value.rejectCode"/>
          </div>
          <div class="grey--text ml-4" v-else>
            RejectCode :  {{value.rejectCode }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="RejectDetail" v-model="value.rejectDetail"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="CookStatus" v-model="value.cookStatus"/>
          </div>
          <div class="grey--text ml-4" v-else>
            CookStatus :  {{value.cookStatus }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
